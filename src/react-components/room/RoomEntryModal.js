      ...
      <div style={{ background: "transparent" }}>
        <Column center className={styles.content}>
          ...
          <Column center className={styles.buttons}>
            {showJoinRoom && (
              <Button preset="accent7" onClick={onJoinRoom}>
                <EnterIcon />
                <span>
            ...
            {showEnterOnDevice && (
              <Button preset="accent8" onClick={onEnterOnDevice}>
                <VRIcon />
                <span>
            ...
            {showSpectate && (
              <Button preset="accent9" onClick={onSpectate}>
                <ShowIcon />
                <span>
            ...
            {showOptions && breakpoint !== "sm" && (
              <>
                ...
                <Button preset="transparent" className={styleUtils.showLg} onClick={onOptions}>
                  <SettingsIcon />
                  <span>
                    <FormattedMessage id="room-entry-modal.options-button" defaultMessage="Settings" />
                  </span>
                </Button>
              </>
            )}
